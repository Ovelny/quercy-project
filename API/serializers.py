...
class Property_Serializer(serializers.ModelSerializer):
    ...
    property_type = serializers.SlugRelatedField(slug_field='label_fr', queryset=Property_Type.objects.all()) 
    heating_type = serializers.SlugRelatedField(slug_field='label_fr', queryset=Heating_Type.objects.all())
    kitchen_type = serializers.SlugRelatedField(slug_field='label_fr', queryset=Kitchen_Type.objects.all())
